...
const teaches = [
  {
    ...
    title: "Forex Basics",
    desc: "How currency markets work and why exchange rates move.",
  },
  ...
  { icon: "ph:newspaper", title: "Market News", desc: "Understanding economic events and how they move markets." },
  {
    ...
    desc: "Stop losses, position sizing, and protecting your capital.",
  },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-core-muted leading-relaxed mb-4">
                CorePips exists to make trading and market education easier to understand for beginners. We believe that
                every person who wants to learn about financial markets deserves access to clear, honest, and structured
                educational content.
              </p>
              <p className="text-core-muted leading-relaxed mb-4">
                We don't sell signals. We don't make profit promises. We don't hype trading as a quick path to wealth.
                Instead, we focus on what actually matters: understanding how markets work, how to manage risk
                responsibly, and how to develop the discipline that any good market participant needs.
              </p>
              <p className="text-core-muted leading-relaxed">
                Our core belief:{" "}
                <span className="font-semibold text-core-ink">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div ref={teachesRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {teaches.map((t) => (
              <div
                key={t.title}
                className="flex gap-4 bg-white rounded-2xl border border-core-line p-5 shadow-sm hover:shadow-md hover:border-blue-200 transition-all"
              >
            ...
            <div>
              ...
              <div className="space-y-3">
                {whoFor.map((w) => (
                  <div
                    key={w.label}
                    className="flex items-center gap-3 p-4 bg-core-soft rounded-xl border border-core-line hover:bg-white hover:border-blue-200 transition-all"
                  >
                ...
                {[
                  {
                    ...
                    desc: "Content is organized from beginner to advanced so knowledge builds logically.",
                  },
                  {
                    icon: "ph:check-circle",
                    title: "Risk awareness from day one",
                    desc: "We introduce risk management early — before strategy, patterns, or indicators.",
                  },
                  {
                    icon: "ph:check-circle",
                    title: "No signal selling or profit promises",
                    desc: "CorePips never claims you'll make money or provides trading signals of any kind.",
                  },
                  {
                    icon: "ph:check-circle",
                    title: "Plain language throughout",
                    desc: "Every concept is explained in simple terms without unnecessary financial jargon.",
                  },
                ].map((item) => (
                  ...
                  <div className="flex items-center gap-2">
                    {["ph:twitter-logo", "ph:instagram-logo", "ph:youtube-logo"].map((icon) => (
                      <a
                        key={icon}
                        href="#"
                        className="w-9 h-9 rounded-lg bg-white border border-core-line flex items-center justify-center text-core-muted hover:text-core-blue hover:border-blue-200 transition-colors"
                      >
